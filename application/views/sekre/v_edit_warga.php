			...
			<div class="row">
				<div class="main-header">
					<div class="card-header">
						<h5><a href="<?= site_url('sekre/data_warga') ?>" style="text-decoration: none; color: black;"><span class="ti-close"></span></a> Edit Warga</h5>
					</div>
					<div class="card-block" style="background-color: white;">
						<form action="<?= site_url('sekre/updateWarga') ?>" method="post">

   ...
   <script type="text/javascript" src="<?php echo base_url() ?>assets/js/main.min.js"></script>
	 <script type="text/javascript" src="<?php echo base_url() ?>assets/views/main.js"></script>
   <script type="text/javascript" src="<?php echo base_url() ?>assets/views/<?= $page ?>.js"></script>
